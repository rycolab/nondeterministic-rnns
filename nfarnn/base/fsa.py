...
import nfarnn
from nfarnn.base.pathsum import Pathsum, Strategy
from nfarnn.base.semiring import Real, Semiring
from nfarnn.base.state import State
from nfarnn.base.symbol import Sym, ε
...
class FSA:
    ...
    def accept(self, string: Union[str, Sequence[Sym]]) -> Semiring:
        ...
        """
        from nfarnn.base.fsa_classes import string_fsa
    ...
    def push(self):
        from nfarnn.base.transformer import Transformer
