...
from nfarnn.base.semiring import Semiring
from nfarnn.base.state import PairState, State
from nfarnn.base.symbol import Sym, ε, ε_1, ε_2
...
class FST(FSA):
    ...
    def compose(self, fst: "FST", augment: bool = True) -> "FST":
        from nfarnn.base.fsa_classes import get_epsilon_filter
